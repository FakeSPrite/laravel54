...
<head>
    ...
    <link href="{{asset('static/css/blog.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset('static//css/wangEditor.min.css')}}">
            ...
            <div class="blog-post">
                <div style="display:inline-flex">
                    ...
                    <a style="margin: auto"  href="/posts/62/delete">
                        <span class="glyphicon gccclyphicon-remove" aria-hidden="true"></span>
                    </a>
                </div>
...
<script src="{{asset('static/js/ylaravel.js')}}"></script>
